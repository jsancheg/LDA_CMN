...
Sets2 <- as.matrix(expand.grid(2, F10, F5, F4, F3, F1, F7, F6, 0.9, 0.8, 0, 30, 5, 0))
Sets3 <- as.matrix(expand.grid(3, F10, F5, F4, F3, F1, F7, F6, 0.9, 0.8, 0.8, 5, 5, 30))
