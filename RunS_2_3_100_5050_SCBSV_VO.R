...
setwd(ruta)
source("S_2_3_100_5050_SCBSV_VO.R")
...
for(i_sim in 4:10){
  ...
  cat("\nWriting file ",i_sim,"\n")
  filename <- paste0(ruta,"/OutputS_2_3_100_5050_SCBSV_VO/Output.txt")
  #  cat("done run ", i_sim, file = filename, sep = "\n", append=TRUE)
  save(sim.A5,file = paste0(ruta,"/OutputS_2_3_100_5050_SCBSV_VO/S_2_3_100_5050_SCBSV_VO_",i_sim,".Rdata") )
