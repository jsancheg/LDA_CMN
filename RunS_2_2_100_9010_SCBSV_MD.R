...
setwd(ruta)
source("S_2_2_100_9010_SCBSV_MD.R")
...
for(i_sim in 6:7){
  ...
  cat("\nWriting file ",i_sim,"\n")
  filename <- paste0(ruta,"/OutputS_2_2_100_9010_SCBSV_MD/Output.txt")
  #  cat("done run ", i_sim, file = filename, sep = "\n", append=TRUE)
  save(sim.A5,file = paste0(ruta,"/OutputS_2_2_100_9010_SCBSV_MD/S_2_2_100_9010_SCBSV_MD_",i_sim,".Rdata") )
