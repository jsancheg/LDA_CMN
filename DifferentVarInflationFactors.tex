...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#pairs(DatasetA$Xtrain, col = c("red","blue")[DatasetA$vtrain + 1],}
\CommentTok{\#      pch = ifelse(DatasetA$vtrain == 0,24,19), cex = 1)}

\FunctionTok{pairs}\NormalTok{(DatasetA}\SpecialCharTok{$}\NormalTok{Xtrain, }\AttributeTok{panel =} \ControlFlowTok{function}\NormalTok{(x,y, ...) \{}
  \FunctionTok{points}\NormalTok{(x,y, }
         \AttributeTok{col =} \FunctionTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{,}\StringTok{"blue"}\NormalTok{)[DatasetA}\SpecialCharTok{$}\NormalTok{vtrain }\SpecialCharTok{+} \DecValTok{1}\NormalTok{],}
         \AttributeTok{pch =} \FunctionTok{ifelse}\NormalTok{(DatasetA}\SpecialCharTok{$}\NormalTok{vtrain }\SpecialCharTok{==} \DecValTok{0}\NormalTok{,}\DecValTok{24}\NormalTok{,}\DecValTok{19}\NormalTok{),}
         \AttributeTok{cex =} \DecValTok{1}\NormalTok{,}
\NormalTok{         ...)}
      \FunctionTok{text}\NormalTok{(x[indAreal\_T0\_P0\_Trainv],y[indAreal\_T0\_P0\_Trainv],}
           \AttributeTok{labels=}\FunctionTok{c}\NormalTok{(indAreal\_T0\_P0\_Trainv),}\AttributeTok{pos =} \DecValTok{4}\NormalTok{)}
\NormalTok{\} )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#pairs(DatasetA$Xtest, col = c("red","blue")[DatasetA$vtest + 1],}
\CommentTok{\#      pch = ifelse(DatasetA$vtest == 0,24,19), cex = 1)}

\FunctionTok{pairs}\NormalTok{(DatasetA}\SpecialCharTok{$}\NormalTok{Xtest, }\AttributeTok{panel =} \ControlFlowTok{function}\NormalTok{(x,y, ...) \{}
  \FunctionTok{points}\NormalTok{(x,y, }
         \AttributeTok{col =} \FunctionTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{,}\StringTok{"blue"}\NormalTok{)[DatasetA}\SpecialCharTok{$}\NormalTok{vtest }\SpecialCharTok{+} \DecValTok{1}\NormalTok{],}
         \AttributeTok{pch =} \FunctionTok{ifelse}\NormalTok{(DatasetA}\SpecialCharTok{$}\NormalTok{vtest }\SpecialCharTok{==} \DecValTok{0}\NormalTok{,}\DecValTok{24}\NormalTok{,}\DecValTok{19}\NormalTok{),}
         \AttributeTok{cex =} \DecValTok{1}\NormalTok{,}
\NormalTok{         ...)}
      \FunctionTok{text}\NormalTok{(x[indAreal\_T0\_P0\_Testv],y[indAreal\_T0\_P0\_Testv],}
           \AttributeTok{labels=}\FunctionTok{c}\NormalTok{(indAreal\_T0\_P0\_Testv),}\AttributeTok{pos =} \DecValTok{4}\NormalTok{)}
\NormalTok{\} )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#pairs(DatasetB$Xtrain, col = c("red","blue")[DatasetB$vtrain + 1],}
\CommentTok{\#      pch = ifelse(DatasetB$vtrain == 0,24,19), cex = 1)}
\FunctionTok{pairs}\NormalTok{(DatasetB}\SpecialCharTok{$}\NormalTok{Xtrain, }\AttributeTok{panel =} \ControlFlowTok{function}\NormalTok{(x,y, ...) \{}
  \FunctionTok{points}\NormalTok{(x,y, }
         \AttributeTok{col =} \FunctionTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{,}\StringTok{"blue"}\NormalTok{)[DatasetB}\SpecialCharTok{$}\NormalTok{vtrain }\SpecialCharTok{+} \DecValTok{1}\NormalTok{],}
         \AttributeTok{pch =} \FunctionTok{ifelse}\NormalTok{(DatasetB}\SpecialCharTok{$}\NormalTok{vtrain }\SpecialCharTok{==} \DecValTok{0}\NormalTok{,}\DecValTok{24}\NormalTok{,}\DecValTok{19}\NormalTok{),}
         \AttributeTok{cex =} \DecValTok{1}\NormalTok{,}
\NormalTok{         ...)}
      \FunctionTok{text}\NormalTok{(x[indBreal\_T0\_P0\_Trainv],y[indBreal\_T0\_P0\_Trainv],}
           \AttributeTok{labels=}\FunctionTok{c}\NormalTok{(indBreal\_T0\_P0\_Trainv),}\AttributeTok{pos =} \DecValTok{4}\NormalTok{)}
\NormalTok{\} )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#pairs(DatasetB$Xtest, col = c("red","blue")[DatasetB$vtest + 1],}
\CommentTok{\#      pch = ifelse(DatasetB$vtest == 0,24,19), cex = 1)}
\FunctionTok{pairs}\NormalTok{(DatasetB}\SpecialCharTok{$}\NormalTok{Xtest, }\AttributeTok{panel =} \ControlFlowTok{function}\NormalTok{(x,y, ...) \{}
  \FunctionTok{points}\NormalTok{(x,y, }
         \AttributeTok{col =} \FunctionTok{c}\NormalTok{(}\StringTok{"red"}\NormalTok{,}\StringTok{"blue"}\NormalTok{)[DatasetB}\SpecialCharTok{$}\NormalTok{vtest }\SpecialCharTok{+} \DecValTok{1}\NormalTok{],}
         \AttributeTok{pch =} \FunctionTok{ifelse}\NormalTok{(DatasetB}\SpecialCharTok{$}\NormalTok{vtest }\SpecialCharTok{==} \DecValTok{0}\NormalTok{,}\DecValTok{24}\NormalTok{,}\DecValTok{19}\NormalTok{),}
         \AttributeTok{cex =} \DecValTok{1}\NormalTok{,}
\NormalTok{         ...)}
\CommentTok{\#      text(x[indBreal\_T0\_P0\_Testv],y[indBreal\_T0\_P0\_Testv],}
\CommentTok{\#           labels=c(indBreal\_T0\_P0\_Testv),pos = 4)}
\NormalTok{\} )}
\end{Highlighting}
\end{Shaded}
