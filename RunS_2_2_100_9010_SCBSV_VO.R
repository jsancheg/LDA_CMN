...
setwd(ruta)
source("Sim_2_2_100_9010_SCBSV_VO.R")
...
for(i_sim in 3:10){
  ...
  cat("\nWriting file ",i_sim,"\n")
  filename <- paste0(ruta,"/OutputS_2_2_4_9010_SCBSV_VO/Output.txt")
  #  cat("done run ", i_sim, file = filename, sep = "\n", append=TRUE)
  save(sim.A5,file = paste0(ruta,"/OutputS_2_2_100_9010_SCBSV_VO/S_2_2_100_9010_SCBSV_VO_",i_sim,".Rdata") )
