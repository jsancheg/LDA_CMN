...
plot(5:20,metrics_d1$Metrics$Specificity_vTrain[5:20]*100, type = "l", lwd = 1,
     col = "blue", ylim=c(ymin,ymax+0.1), ylab = "Specificiy",xlab = "Iterations")
lines(5:20,metrics_d1$Metrics$Specificity_vTest[5:20]*100, lwd = 2,col = "green")
...
plot(5:20,metrics_d1$Metrics$Precision_vTrain[5:20]*100, type = "l", lwd = 1,
     col = "blue", ylim=c(ymin-1,ymax+2), ylab = "Precision",xlab = "Iterations")
lines(5:20,metrics_d1$Metrics$Precision_vTest[5:20]*100, lwd = 2,col = "green")
legend("topleft",legend= c("Train","Test"),col = c("blue","green"),lwd = c(1,2))
