...
for(i_sim in 1:10){
  ...
  cat("\nWriting file ",i_sim,"\n")
  filename <- paste0(ruta,"/OutputS_2_3_4_BAL_IND_VO/Output.txt")
  #  cat("done run ", i_sim, file = filename, sep = "\n", append=TRUE)
  save(sim.A5,file = paste0(ruta,"/OutputS_2_3_4_BAL_IND_VO/S_2_3_4_BAL_IND_VO_",i_sim,".Rdata") )
