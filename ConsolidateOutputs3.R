...
process_file3 <- function(filename)
{
  ...
  colnames(resumen)<-c("Model","AccuracyTM","AccuracyCompleteModel",
                       "AccuracyCompleteModelContaminated",
                       "AccuracyCompleteModelNoContaminated",
                       "AccuracySM","ModelSizeSM",
  ...
  for(i_run in 2:l)
  {
    ...
    if(length(sim.A5[[i_run]])>1)
    {
      ...
      colnames(auxdf1)<-c("Model","AccuracyTM","AccuracyCompleteModel",
                          "AccuracyCompleteModelContaminated",
                          "AccuracyCompleteModelNoContaminated",
                          "AccuracySM","ModelSizeSM",
                          "Inclusion_correctness","Number_var_incorrect_included",
