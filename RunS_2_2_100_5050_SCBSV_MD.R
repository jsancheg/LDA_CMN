...
setwd(ruta)
source("Sim_2_2_100_5050_SCBSV_MD.R")
...
cat("\nWriting file ",i_sim,"\n")
filename <- paste0(ruta,"/OutputS_2_2_100_5050_SCBSV_MD/Output.txt")
#  cat("done run ", i_sim, file = filename, sep = "\n", append=TRUE)
save(sim.A5,file = paste0(ruta,"/OutputS_2_2_100_5050_SCBSV_MD/S_2_2_100_5050_SCBSV_MD_",i_sim,".Rdata") )
