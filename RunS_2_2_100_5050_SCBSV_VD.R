...
setwd(ruta)
source("Sim_2_2_100_5050_SCBSV_VD.R")
...
for(i_sim in 1:10){
  ...
  cat("\nWriting file ",i_sim,"\n")
  filename <- paste0(ruta,"/OutputS_2_2_100_5050_SCBSV_VD/Output.txt")
  #  cat("done run ", i_sim, file = filename, sep = "\n", append=TRUE)
  save(sim.A5,file = paste0(ruta,"/OutputS_2_2_100_5050_SCBSV_VD/S_2_2_100_5050_SCBSV_VD_",i_sim,".Rdata") )
