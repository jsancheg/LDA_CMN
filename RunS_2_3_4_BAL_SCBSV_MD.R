...
setwd(ruta)
source("Sim_2_3_4_BAL_SCBSV_MD.R")
...
for(i_sim in 1:10){
  ...
  cat("\nWriting file ",i_sim,"\n")
  filename <- paste0(ruta,"/OutputS_2_3_4_BAL_SCBSV_MD/Output.txt")
  #  cat("done run ", i_sim, file = filename, sep = "\n", append=TRUE)
  save(sim.A5,file = paste0(ruta,"/OutputS_2_3_4_BAL_SCBSV_MD/S_2_3_4_BAL_SCBSV_MD_",i_sim,".Rdata") )
