...
setwd(ruta)
source("S_2_3_100_5050_IND_MD.R")
...
for(i_sim in 2:10){
  ...
  cat("\nWriting file ",i_sim,"\n")
  filename <- paste0(ruta,"/OutputS_2_3_100_5050_IND_MD/Output.txt")
  #  cat("done run ", i_sim, file = filename, sep = "\n", append=TRUE)
  save(sim.A5,file = paste0(ruta,"/OutputS_2_3_100_5050_IND_MD/S_2_3_100_5050_IND_MD_",i_sim,".Rdata") )
