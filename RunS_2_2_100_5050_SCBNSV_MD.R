...
setwd(ruta)
source("Sim_2_2_100_5050_SCBNSV_MD.R")
...
for(i_sim in 1:10){
  ...
  cat("\nWriting file ",i_sim,"\n")
  filename <- paste0(ruta,"/OutputS_2_2_100_5050_SCBNSV_MD/Output.txt")
  #  cat("done run ", i_sim, file = filename, sep = "\n", append=TRUE)
  save(sim.A5,file = paste0(ruta,"/OutputS_2_2_100_5050_SCBNSV_MD/S_2_2_100_5050_SCBNSV_MD_",i_sim,".Rdata") )
