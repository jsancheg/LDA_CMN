...
lambda_ArealDifr <- round(ms_ADifrealv$lambda,2)
...
par0 <- list(G = G_a, pig = pig_a, mu = fit_AEq$models[[1]]$mu,
             sigma = diag(1,p_a), alpha = fit_AEq$models[[1]]$alpha,
             eta = fit_AEq$models[[1]]$eta, z = DatasetA$ltrain,
             v = fit_AEq$models[[1]]$v, lambda = fit_AEq$models[[1]]$Sigma[1,1,1])
...
lambda_BrealDifr <- round(ms_BDifrealv$lambda,2)
...
par0 <- list(G = G_b, pig = pig_b, mu = fit_BEq$models[[1]]$mu,
             sigma = diag(1,p_a), alpha = fit_BEq$models[[1]]$alpha,
             eta = fit_BEq$models[[1]]$eta, z = DatasetB$ltrain,
             v = fit_BEq$models[[1]]$v, lambda = fit_BEq$models[[1]]$Sigma[1,1,1])
...
$$
\mu = \begin{pmatrix} 0 \\ 0 \\ 0\\ \end{pmatrix} , \Sigma = I_{3} = \begin{pmatrix} 1 & 0 & 0  \\ 0 & 1 & 0  \\ 0 & 0 & 1   \\ \end{pmatrix}, \alpha = `r format(alpha_a,digits = 2)` , \eta = `r format(eta_a,digits = 2)`
$$
